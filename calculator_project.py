...
expression = "" 
def press(num): 
    global expression  #global expression variable
...
if __name__ == "__main__": 
    ...
    button00 = Button(gui, text=' 00 ', fg='black', bg='red',command=lambda: press('00'), height=1, width=7) 
    button00.grid(row=5, column=1) 
 
    Decimal= Button(gui, text='.', fg='black', bg='red',command=lambda: press('.'), height=1, width=7) 
    Decimal.grid(row=6, column=0) 
 
    pie= Button(gui, text='pi', fg='black', bg='red',command=lambda: press('*3.14'), height=1, width=7) 
    pie.grid(row=5, column=2)

    percent= Button(gui, text='%', fg='black', bg='red',command=lambda: press('*(1/100)'), height=1, width=7) 
    percent.grid(row=6, column=2)

    parenthes= Button(gui, text='(', fg='black', bg='red',command=lambda: press('('), height=1, width=7) 
    parenthes.grid(row=7, column=0)
    parenthe= Button(gui, text=')', fg='black', bg='red',command=lambda: press(')'), height=1, width=7) 
    parenthe.grid(row=7, column=1)

    power = Button(gui, text=' ** ', fg='black', bg='red',command=lambda: press("**"), height=1, width=7) 
    ...
    power = Button(gui, text=' **2 ', fg='black', bg='red',command=lambda: press("**2"), height=1, width=7) 
